...
function switchLocale(loc) {
  router.get(route('content-manager.about-us'), { content_locale: loc }, { preserveScroll: true });
}
function submit() {
  ...
  <AuthenticatedLayout>
    ...
    <div class="admin-form-page">
      ...
      <div class="admin-box admin-box-smooth mb-3">
        <CmsLocaleSelect :model-value="contentLocale" id="about-content-locale" @update:model-value="switchLocale" />
      </div>
